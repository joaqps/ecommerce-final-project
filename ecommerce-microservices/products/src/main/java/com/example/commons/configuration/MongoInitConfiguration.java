...
public class MongoInitConfiguration {
	...
	public Jackson2RepositoryPopulatorFactoryBean getRepositoryPopulator(MongoTemplate mongoTemplate,
		...
		factory.setResources(new Resource[]{new ClassPathResource("mongo/brands.json"),
				new ClassPathResource("mongo/products.json"), new ClassPathResource("mongo/rates.json")});
