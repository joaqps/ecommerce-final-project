...
class RateEntityMapperTest {
	...
	void test_mapper() {
		...
		RateEntity entity = new RateEntity("1", BrandEntity.builder().id("2").build(),
				ProductEntity.builder().id("3").build(), LocalDateTime.of(2020, 6, 28, 12, 32, 2),
				LocalDateTime.of(2021, 7, 29, 13, 33, 3), 1, BigDecimal.valueOf(25.45), "EUR");
