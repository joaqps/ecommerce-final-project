...
public class MongoInitConfiguration {
  ...
  public Jackson2RepositoryPopulatorFactoryBean getRepositoryPopulator(MongoTemplate mongoTemplate, ObjectMapper mapper) {
    ...
    factory.setResources(new Resource[] { new ClassPathResource("mongo/brands.json"), new ClassPathResource("mongo/products.json"),
        new ClassPathResource("mongo/rates.json"), new ClassPathResource("mongo/users.json") });
